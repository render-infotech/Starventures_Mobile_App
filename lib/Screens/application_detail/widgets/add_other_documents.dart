...
class AddOtherDocuments extends StatefulWidget {
  const AddOtherDocuments({super.key});

  @override
  State<AddOtherDocuments> createState() => _AddOtherDocumentsState();
}

class _AddOtherDocumentsState extends State<AddOtherDocuments> {
  // Dummy docs
  final _docs = const [
    _DocItem(title: 'Current Payslip', ext: 'PDF', sizeLabel: '1.2 MB'),
    _DocItem(title: 'Offer Letter', ext: 'PDF', sizeLabel: '0.8 MB'),
    _DocItem(title: 'Appointment Letter', ext: 'image', sizeLabel: '0.5 MB'),
  ];
