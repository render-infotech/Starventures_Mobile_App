        ...
        body: _controller.dashboardLoading.value
          ...
          onRefresh: _controller.refreshDashboard,
              child: SingleChildScrollView(
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 130), // Adjust based on header height
                  child: Container(
                              ...
                              itemBuilder: (context, index) {
                                final tiles = <_Tile>[
                                  _Tile(
                                      ...
                                      value: _controller.assignedApplications.toString()
                                  ),
                                  _Tile(
                                ...
                                return InkWell(
                                  ...
                                  onTap: () {
                                    switch (index) {
                                      case 2:
                                        ApplicationTypeBottomSheet.show(context).then((selectedType) {
                                          if (selectedType != null) {
                                            Get.toNamed(
                                              AppRoutes.newapplication,
                                              arguments: {'selectedApplicationType': selectedType},
                                            );
                                          }
                                        });
                                        break;
